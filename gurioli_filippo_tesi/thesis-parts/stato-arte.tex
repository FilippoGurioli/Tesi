...
\section{Extended Reality}\label{sec:XR}
    ...
    \subsection{Storiografia}\label{subsec:XRstoriografia}
        ...
        \paragraph{L'HTC Vive} (figura\ref{fig:HTCVive.jpg}) è uno dei più famosi visori VR, è stato sviluppato da HTC e Valve Corporation ed è
...
\section{Videogiochi}\label{sec:Videogiochi}
    ...
    \subsection{Storiografia}\label{subsec:VideogiochiStoriografia}
        ...
        \paragraph{Doom} è stato il primo \textit{First Person Shooter} (FPS) mai creato. Il gioco, in sè semplice e consiste di un marine, controllato dal giocatore, che deve sopravvivere
            all'invasione di demoni provenienti dall'inferno (figura\ref{fig:Doom.png}). Questo gioco è stato sviluppato da id Software nel 1993 ed è stato il primo gioco a utilizzare la tecnologia \textit{ray casting} 
            ...
            se connesse alla stessa LAN, lasciando agli utenti anche la scelta tra un gioco cooperativo (\textit{co-op}) o competitivo (\textit{deathmatch}).
    ...
    \subsection{Categorie}\label{subsec:VideogiochiCategorie}
        I videogiochi si possono analizzare secondo diversi criteri, ognuno di questi criteri identifica un'insieme di categorie da cui si derivano i vari generi e sottogeneri.
...
\section{Multigiocatore}\label{sec:Multigiocatore}
    ...
    \subsection{Storiografia}\label{subsec:MultiStoriografia}
        ...
        \paragraph{I \textit{web games}}, come già accennato prima, rappresentano il settore più in voga al giorno d'oggi. Dalla loro nascita non è stato più necessario creare un
            file sorgente da far scaricare a tutti i giocatori, bensì è sufficiente creare un sito web che permetta di giocare direttamente dal browser. Una rivoluzione del genere
            è stata resa possibile grazie alla nascita di nuove tecnologie, come HTML5, CSS3 e JavaScript, che hanno portato il web programming al livello successivo. Queste tre 
            tecnologie nello specifico hanno dato accesso a funzionalità prima disponibili solo su applicazioni desktop, come l'accesso ai file system, la possibilità di creare
            animazioni e la creazione di applicazioni interattive. Negli ultimi anni si sono anche sviluppati strumenti \textit{WebXR}, ovvero strumenti che consentono di trasportare
            la tecnologia XR sul web. I più famosi strumenti WebXR sono \textit{A-Frame}, \textit{Babylon.js} e \textit{Three.js}.\\
